...
export const CONTENT: ContentCollectionDef[] = [
  ...
  {
    key: "spotlightCategories",
    title: "Spotlight talents",
    itemNoun: "talent",
    blurb: "The talent list on the Spotlight page and the dropdown on the registration form — they read the same list. The wildcard should stay last.",
    labelField: "title",
    imageFolder: "spotlight",
    fields: [
      { name: "title", label: "Talent", type: "text", hint: "BEATBOXING" },
      { name: "value", label: "Saved as", type: "text", hint: "The short word stored with each entry, e.g. Beatboxing." },
      { name: "body", label: "One line about it", type: "text" },
    ],
    seed: [
      { title: "SINGING", value: "Singing", body: "Playback, original, unplugged, a cappella — with a track or without." },
      { title: "SOLO DANCE", value: "Solo dance", body: "Classical, hip-hop, contemporary, or something that has no name yet." },
      { title: "GROUP DANCE", value: "Group dance", body: "Formations, crews, a class that has been rehearsing since July." },
      { title: "RAP", value: "Rap", body: "Written or freestyle. Bring your own beat or take ours." },
      { title: "BEATBOXING", value: "Beatboxing", body: "One mic, no instruments, and a room that goes quiet." },
      { title: "STAND-UP COMEDY", value: "Stand-up", body: "Tight five, clean-ish. The crowd is your family's friends." },
      { title: "POETRY", value: "Poetry", body: "Any language. Read it or know it by heart." },
      { title: "SPOKEN WORD", value: "Spoken word", body: "The one you wrote at 2 AM and have not shown anybody." },
      { title: "MIMICRY", value: "Mimicry", body: "Voices, teachers, cricket commentators, film stars." },
      { title: "MUSICAL INSTRUMENT", value: "Instrument", body: "Guitar, tabla, keys, flute, violin — solo instrumental." },
      { title: "BANDS", value: "Band", body: "Full line-up, full backline, the longest slot on the stage." },
      { title: "MAGIC", value: "Magic", body: "Close-up on the big screen, or stage illusion." },
      { title: "FREESTYLE", value: "Freestyle", body: "Unscripted, unrehearsed, decided in the moment." },
      { title: "WILDCARD", value: "Wildcard", body: "Whatever you do that none of the above describes. This is the one we are most curious about." },
    ],
  },
  {
    key: "spotlightPrizes",
    title: "Spotlight prizes",
    itemNoun: "prize",
    blurb: "The prize list on the Spotlight page.",
    labelField: "amount",
    imageFolder: "spotlight",
    fields: [
      { name: "amount", label: "Amount", type: "text", hint: "₹15,000, or a word like CROWD." },
      { name: "title", label: "What for", type: "text", hint: "Spotlight Winner" },
      { name: "note", label: "The rest of the line", type: "text" },
    ],
    seed: [
      { amount: "₹15,000", title: "MADOOZA Spotlight Winner", note: "plus the trophy, the certificate, and the closing slot on the main stage" },
      { amount: "₹5,000", title: "Category Winner", note: "one in each talent that fills its heat" },
      { amount: "₹5,000", title: "People's Choice", note: "voted live by the crowd on the day" },
      { amount: "STUDIO", title: "Best Musical Act", note: "a day of professional studio recording, and the files are yours" },
    ],
  },
  {
  ...
  },
  {
    ...
    seed: [
      ...
      { title: "MADOOZA SPOTLIGHT", pageKey: "spotlight", kicker: "06 / STAGE", body: "Your talent, your stage, your moment. Fourteen talents, one open stage, and a wildcard for whatever you do." },
